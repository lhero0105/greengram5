...
public class UserService {
    ...
    public ResVo signup(UserSignupDto dto){
        ...
        return new ResVo(entity.getIuser().intValue());// Long -> int 컨버팅
    }
    ...
    public UserSigninVo signin(HttpServletResponse res, UserSigninDto dto) {
        ...
        UserEntity entity = optEntity.orElseThrow(() -> new RestApiException(AuthErrorCode.NOT_EXIST_USER_ID)); // 에러면 에러를 터트립니다.
